<section>
    ...
    <p>           
        <ul >
            <li>Vous pouvez modifier le contenu du site (supprimer/modifier les tutos).<br /></li>
            <li>Vous pouvez consulter vos droits.<br /></li>
            <li>Si vous possédez les droits <span>root</span> vous êtes en mesure de modifier la structure du site (les pages) et administrer les utilisateurs (ajouter/supprimer/modifier).<br /></li>
        </ul>
    </p>
    <?php
